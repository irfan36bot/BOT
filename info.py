...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "🎗️ <i><b>{title} ({year}) {kind} ━━━━━━━━━━━━━━━━━ 🎭 Genre › {genres} ⭐ Rating › {rating} / 10 📚 Story ›</b> {plot} </i> •────────────────• <b><i>🔆彡[ @HEROFLiX ]彡🔆</i></b> <i>Click On Any File From Below To Download It 👇</i>")
